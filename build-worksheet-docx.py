...
def build_worksheet():
    ...
    reflections = [
        ...
        ('31', 'What’s the MAX you think a senior would realistically pay for the Senior Package? Would your classmates have actually paid the price YOU set in the game?'),
        ('32', 'How well did the game’s prom and Senior Package costs match what you’d EXPECTED them to cost in real life? Do you plan on holding your real prom in the gym (like many do in the game) to make the numbers work?'),
        ('33', 'How close is YOUR REAL grade to affording the prom + Senior Package you’d actually want? If there’s a gap — what’s your plan to close it?'),
    ]
